...
dc.barChart = function (parent, chartGroup) {
     ...
     * When using standard d3.v3.js rounding methods, the brush often doesn't align correctly with
...
return dc;}
    if(typeof define === "function" && define.amd) {
        define(["js/d3.v3", "crossfilter"], _dc);
    } else if(typeof module === "object" && module.exports) {
        var _d3 = require('js/d3.v3');
